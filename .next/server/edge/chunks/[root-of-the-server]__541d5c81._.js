(globalThis.TURBOPACK || (globalThis.TURBOPACK = [])).push(["chunks/[root-of-the-server]__541d5c81._.js",
...
"[project]/src/lib/db.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
"[project]/lib/auth-simple.js [middleware-edge] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/lib/db.js [middleware-edge] (ecmascript)");
;
;
;
...
async function hashPassword(password) {
    const saltRounds = 12;
    const salt = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].genSalt(saltRounds);
    const hash = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$bcryptjs$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].hash(password, salt);
    return {
        hash,
        salt
    };
...
function generateJWT(payload) {
    return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].sign(payload, process.env.JWT_SECRET, {
...
function verifyJWT(token) {
    try {
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$jsonwebtoken$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["default"].verify(token, process.env.JWT_SECRET, {
            issuer: 'bissbay-admin',
            audience: 'bissbay-admin-panel'
        });
    } catch (error) {
...
async function createUser(username, password) {
    const connection = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["createConnection"])();
    try {
        // Validate input
...
var __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$simple$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/lib/auth-simple.js [middleware-edge] (ecmascript)");
;
;
async function middleware(request) {
    ...
    if (pathname.startsWith('/admin')) {
        ...
        try {
            ...
            // Validate session
            const sessionData = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$lib$2f$auth$2d$simple$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["validateSession"])(sessionToken);
            if (!sessionData) {
                // Clear invalid cookie and redirect
                const redirectResponse = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$esm$2f$server$2f$web$2f$exports$2f$index$2e$js__$5b$middleware$2d$edge$5d$__$28$ecmascript$29$__["NextResponse"].redirect(new URL('/admin', request.url));
...
//# sourceMappingURL=%5Broot-of-the-server%5D__541d5c81._.js.map
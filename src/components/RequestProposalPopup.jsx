...
import Stepper, { Step } from "../app/resources/request-proposal/Stepper";
import MultiSelectField from "../app/resources/request-proposal/MultiSelectField";
...
function RequestProposalPopup({ isOpen, onClose }) {
  ...
  return (
    ...
    >
      <div className="bg-white rounded-md max-w-4xl w-full max-h-[85vh] overflow-y-auto overflow-hidden shadow-xl relative border-t-8 border-b-8 border-t-primary border-b-gray-500">
        <button
          onClick={handleClose}
        ...
        <div className="p-4 md:p-6">
          <div className="mb-4">
            ...
            <p className="text-gray-600 text-center text-sm">
              Tell us about your lead generation needs and get a customized proposal.
            </p>
          </div>
...
export default RequestProposalPopup;
...
export async function POST(request) {
    ...
    try {
        ...
        return NextResponse.json(
            { 
                success: true,
                message: 'Brand guidelines form submitted successfully',
                id: result.insertId 
            },
            { status: 201 }
        );
        ...
        return NextResponse.json(
            { error: 'Failed to submit brand guidelines form. Please try again later.' },
            { status: 500 }
        );
    }
}
...
export async function GET(request) {
    try {
        ...
        return NextResponse.json(
            { error: 'Failed to fetch brand guidelines submissions' },
            { status: 500 }
        );
    }
}
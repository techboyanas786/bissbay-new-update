...
function Vendor() {
  ...
  const logos = [
    ...
    { src: "/logos/UKG.png", name: "UKG", size: 90, top: "25%", left: "65%" },
    {
    ...
    { src: "/logos/SAP.png", name: "SAP", size: 130, top: "50%", left: "15%" },
    {
    ...
    { src: "/logos/okta.png", name: "Okta", size: 70, top: "30%", left: "14%" },
    {

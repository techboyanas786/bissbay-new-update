...
const categories = [
  { category: "Financial Operations", value: "142K", percentage: 100 },
  { category: "Corporate Accounting", value: "91K", percentage: 64 },
  { category: "Tax & Insurance", value: "45K", percentage: 32 },
  { category: "Credit Management", value: "41K", percentage: 29 },
  { category: "Financial Leadership", value: "33K", percentage: 23 },
  { category: "Financial Planning & Analysis", value: "35K", percentage: 25 },
  { category: "Transactional Finance", value: "16K", percentage: 11 },
];
          ...
          <div className="container mx-auto grid grid-cols-1 sm:grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-2 md:grid-cols-2 place-items- ">
            <div className="sm:border-r-2 border-gray-300">
              <Image
                ...
                height={48}
              />
              <h2 className="text-[36px] !text-primary !mb-0">403,200</h2>
              <h1  >
                Engaged
                <br /> Decision-Makers
              </h1>
              <p className="mt-4 md:mt-6  mb-4 md:mb-8 max-w-2xl">
                We match content with finance professionals based on their role
                and expertise, giving your solution the best chance to reach the

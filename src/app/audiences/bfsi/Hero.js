        ...
        <div className="flex flex-col lg:h-[500px] lg:flex-row items-center gap-6 lg:gap-8">
          <div className="w-full md:w-1/2 mb-0">
            ...
            <h6 className="lg:!text-[1.125rem] mb-6 sm:mb-8  lg:!leading-relaxed lg:!font-semibold !text-[#5C6371]">
              We support Banking, Financial Services and Insurance leaders in
              evaluating solutions for their toughest challenges.
              <br className="hidden sm:block" /> Ensure your brand stays on their radar.
            </h6>
          ...
          <div className="w-full md:w-1/2 bg-gray-100">
              <Lottie className="relative h-[400px] md:h-[500px] animate-on-scroll" animationData={BFSI} loop={true} />
          </div>
        </div>
      </div>
    </section>
